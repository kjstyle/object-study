package chaper01.step02;

import chapter01.step02.Audience;
import chapter01.step02.Bag;
import chapter01.step02.Invitation;
import chapter01.step02.Theater;
import chapter01.step02.Ticket;
import chapter01.step02.TicketOffice;
import chapter01.step02.TicketSeller;
...
public class TheaterTest {
	...
	@Before
	public void setUp() {
		this.ticketOffice = new TicketOffice(INIT_OFFICE_AMOUNT, new Ticket(TICKET_FEE), new Ticket(TICKET_FEE), new Ticket(TICKET_FEE), new Ticket(TICKET_FEE),
				new Ticket(TICKET_FEE));
